...
public class ContactFragment extends BaseFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ExpandableListAdapter expandableAdapter = new ContactExpandableListAdapter();
        expandableView.setAdapter(expandableAdapter);
    }

    private class ContactExpandableListAdapter implements ExpandableListAdapter {

        public ContactExpandableListAdapter() {
            usr = act.getUsr("");
        }
